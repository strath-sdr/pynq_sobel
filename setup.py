...
# variable
package_name = "pynq_sobel"
board = os.environ['BOARD']
board_notebooks = os.path.join(os.environ['PYNQ_JUPYTER_NOTEBOOKS'], 'pynq_sobel')
...
setup(
    ...
    description="Hardware Accelerated Sobel Filter for PYNQ.")
